...
private:
    ...
    const QSet<QString> code_organs_internal =
        {
            "1021", "1022", "1023", "1050.10.", "1050.11.", "1050.61", "1050.62", "1050.63",
            "1050.62.1", "1050.62.2", "1050.63.1", "1021.", "1022.",
            "1023.", "1050.61.", "1050.62.", "1050.63.", "1050.62.1.",
            "1050.62.2.", "1050.63.1."
        };

    const QSet<QString> code_urynari_system =
        {
            "1021", "1022", "1024", "1050.19", "1050.20", "1050.61", "1050.62", "1050.63",
            "1050.62.1", "1050.62.2", "1050.63.1",
            "1021.", "1022.", "1024.", "1050.19.", "1050.20.", "1050.61.", "1050.62.", "1050.63.",
            "1050.62.1.", "1050.62.2.", "1050.63.1."
        };
    ...
    const QSet<QString> code_prostate =
        {
            "1021", "1025", "1038", "1050.55", "1050.62.1", "1050.62.2",
            "1025.", "1038.", "1050.55.", "1050.62.1.", "1050.62.2."
        };

    const QSet<QString> code_gynecologie =
        {
            "1026", "1033", "1050.22", "1050.23", "1050.25", "1050.26", "1050.62", "1050.63",
            "1050.63.1", "1050.69", "1026.", "1033.", "1050.22.", "1050.23.", "1050.25.",
            "1050.26.", "1050.62.", "1050.63.", "1050.63.1.", "1050.69."
        };

    const QSet<QString> code_breast =
        {
            "1037", "1037.1", "1050.34", "1050.35", "1050.63.1",
            "1037.", "1037.1.", "1050.34.", "1050.35.", "1050.63.1."
        };

    const QSet<QString> code_thyroide =
        {
            "1036", "1036.1", "1050.31", "1050.32", "1050.62.2", "1050.63.1",
            "1036.", "1036.1.", "1050.31.", "1050.32.", "1050.62.2.", "1050.63.1."
        };

    const QSet<QString> code_gestation0 =
        {
            "1027", "1027.1", "1028", "1028.1", "1050.66", "1050.67",
            "1027.", "1027.1.", "1028.", "1028.1.", "1050.66.", "1050.67."
        };

    const QSet<QString> code_gestation1 =
        {
            "1027.4.1", "1027.5.1", "1028.4.1", "1028.4.2",
            "1028.4.1.", "1028.4.2."
        };

    const QSet<QString> code_gestation2 =
        {
            "1029.1.1", "1029.1.2", "1029.2", "1029.21", "1029.3", "1029.31",
            "1029.1.1.", "1029.1.2.", "1029.2.", "1029.21.", "1029.3.", "1029.31."
        };
