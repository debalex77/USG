    ...
    , ui(new Ui::AsistantTipApp)
{
    ...
    connect(ui->btnNext, &QAbstractButton::clicked,
            this, &AsistantTipApp::stepNext, Qt::UniqueConnection);
    connect(ui->btnPreview, &QAbstractButton::clicked,
            this, &AsistantTipApp::stepPreview, Qt::UniqueConnection);
    connect(ui->btnClose, &QAbstractButton::clicked,
            this, &AsistantTipApp::onClose, Qt::UniqueConnection);
