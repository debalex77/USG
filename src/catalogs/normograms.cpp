...
{
    connect(ui->btnNT, &QAbstractButton::clicked,
            this, &Normograms::click_btn_NT, Qt::UniqueConnection);
    connect(ui->btnBN, &QAbstractButton::clicked,
            this, &Normograms::click_btn_BN, Qt::UniqueConnection);
    connect(ui->btnIndexAmniotic, &QAbstractButton::clicked,
            this, &Normograms::click_btn_indexAmniotic, Qt::UniqueConnection);
    connect(ui->btnDopplerUterine, &QAbstractButton::clicked,
            this, &Normograms::click_btn_uterine, Qt::UniqueConnection);
    connect(ui->btnDopplerUmbelical, &QAbstractButton::clicked,
            this, &Normograms::click_btn_umbelicale, Qt::UniqueConnection);
}
