...
AbstractColumn1::AbstractColumn1(QString name) : _name(name)
{
}

//-----------------------------------------------------------------

SimpleColumn::SimpleColumn(QString name) : AbstractColumn1(name)
{
}
...
void VariantMapTableModel::registerColumn(AbstractColumn1 *column)
{
