...
class AbstractColumn1
{
public:
    AbstractColumn1(QString name);
...
class SimpleColumn : public AbstractColumn1
{
public:
...
public:
    ...
    void registerColumn(AbstractColumn1* column);
...
private:
    ...
    QList<AbstractColumn1*> _columns;
};
