...
{
    m_actionAddItem = this->addAction(QIcon(":/img/toolBar/add.png"), QLineEdit::ActionPosition::TrailingPosition);
    ...
    m_actionOpenList = this->addAction(QIcon(":/img/actions/select.png"), QLineEdit::ActionPosition::TrailingPosition);
    m_actionOpenList->setToolTip(tr("Selecteaz\304\203 din lista cu \310\231abloane"));
    connect(m_actionOpenList, &QAction::triggered,
            this, &LineEditCustom::onClickSelect, Qt::UniqueConnection);
}
