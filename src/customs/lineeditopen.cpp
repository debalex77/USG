...
{
    action_open = this->addAction(QIcon(":/img/catalogs/open_catalog.png"), QLineEdit::ActionPosition::TrailingPosition);
    action_open->setToolTip(tr("Deschide fișierul"));
    connect(action_open, &QAction::triggered,
            this, &LineEditOpen::onClickedButton, Qt::UniqueConnection);
    ...
    connect(this, &QLineEdit::textChanged,
            this, &LineEditOpen::onTextChanged, Qt::UniqueConnection);
}
