...
//    nameLocale.replace(QString("_"), QString("-")); // schimbam simbolul
    ...
    connect(ui->comboLangApp, QOverload<int>::of(&QComboBox::currentIndexChanged),
            this, &InitLaunch::changeIndexComboLangApp, Qt::UniqueConnection);
    connect(ui->comboLangApp, QOverload<int>::of(&QComboBox::currentIndexChanged),
            this, &InitLaunch::dataWasModified, Qt::UniqueConnection);

    connect(ui->radBtnFirstLaunch, &QRadioButton::clicked,
            this, &InitLaunch::onClickedRadBtnFirstLaunch, Qt::UniqueConnection);
    connect(ui->radBtnFirstLaunch, &QRadioButton::clicked,
            this, &InitLaunch::dataWasModified, Qt::UniqueConnection);
    connect(ui->radBtnAppMove, &QRadioButton::clicked,
            this, &InitLaunch::onClickedRadBtnAppMove, Qt::UniqueConnection);
    connect(ui->radBtnAppMove, &QRadioButton::clicked,
            this, &InitLaunch::dataWasModified, Qt::UniqueConnection);

    connect(ui->btnOK, &QPushButton::clicked,
            this, &InitLaunch::onWritingData, Qt::UniqueConnection);
    connect(ui->btnClose, &QPushButton::clicked,
            this, &InitLaunch::onClose, Qt::UniqueConnection);
