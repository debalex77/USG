#ifndef REPORTPAGEGYNECOLOGY_H
#define REPORTPAGEGYNECOLOGY_H
...
namespace Ui {
class ReportPageGynecology;
}

class ReportPageGynecology : public ReportPageBase
{
    Q_OBJECT

public:
    explicit ReportPageGynecology(DataBase &db,
                                  QSqlDatabase &currentDB,
                                  QWidget *parent = nullptr);
    ~ReportPageGynecology();
    ...
    bool isTransvaginal() const;

private slots:
    void updateMenstrualStatus();
...
private:
    ...
    struct FindingsTemplatesBtn {
        QToolButton    *btn_select = nullptr;
        QToolButton    *btn_add    = nullptr;
