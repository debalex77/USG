...
public:
    ...
    QSqlDatabase getDatabaseThread(const QString &connectionName,
                                   bool mysql,
                                   QString prefixConn = "[THREAD]");
    QSqlDatabase getDatabaseImagesThread(const QString &connectionName);
    QSqlDatabase getDatabaseSyncThread(const QString &connectionName = "cloud_sync_conn");
